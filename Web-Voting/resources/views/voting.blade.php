...
<body class=" relative bg-gray-900">
    ...
    <div class="w-screen flex flex-col mt-[80px] gap-[10vh] items-center px-[10vw] py-[3vh]
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] dark:bg-gray-800 dark:border-gray-700 duration-[0.5s]
                    hover:scale-[1.03]">
            <img class="rounded-t-lg" src="{{url('img/ganjar.png')}}" alt="" />
            <div class="p-5 text-center">
                <h5 class="mb-2 text-[40px] font-bold tracking-tight text-gray-900 dark:text-white">01</h5>
                <h5 class="mb-[3vh] text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fulan Bin Fulan</h5>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] dark:bg-gray-800 dark:border-gray-700 duration-[0.5s]
            ...
            <img class="rounded-t-lg" src="{{url('img/ganjar.png')}}" alt="" />
            <div class="p-5 text-center">
                <h5 class="mb-2 text-[40px] font-bold tracking-tight text-gray-900 dark:text-white">02</h5>
                <h5 class="mb-[3vh] text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fulan Bin Fulan</h5>
    ...
    <div class="hidden" id="confirm-vote">
              ...
              <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  ...
                  <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" id="agreement" class="inline-flex w-full justify-center rounded-md bg-[#06CD7D] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#44BD82] sm:ml-3 sm:w-auto">Yakin</button>
                    <button type="button" id="closeOverlay" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Batal</button>
                  </div>
                </div>
              </div>
            </div>
